...
export default function Home() {
  ...
  const [activePlayMode, setActivePlayMode] = useState<"voting" | "sambat-sehat" | "love" | "apresiasi" | null>(null);
  ...
  const handleSelectPlayMode = (mode: "voting" | "sambat-sehat" | "love" | "apresiasi") => {
